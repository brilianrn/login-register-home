...
import "./style/loginAdmin.style.css";
import { useDispatch } from "react-redux";
import { setUserLoginAdminAsync, setUserLoginAsync } from '../store/actions/user.action';
...
export default function Main() {
  ...
  function login(event) {
    ...
    try {
      dispatch(setUserLoginAdminAsync({ email: form.email, password: form.password, navigate }));
    } catch (_) {
      title = "Peringatan!";
  ...
  return (
    <div class="wrapper">
      ...
      <div class="text-center mt-4 name">SIGN IN ADMIN</div>
      <form class="p-3 mt-3">
